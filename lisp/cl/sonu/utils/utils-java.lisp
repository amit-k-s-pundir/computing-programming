...
(ql-load-packages '(:cl-who :cl-ppcre :parenscript
                      :cl-fad))


(defpackage  :tc-automation
										;  (:export )
  (:use :cl :parenscript :cl-who :cl-ppcre :cl-fad :ql))
...
;; The syntax of defjavaclass is analogous to the defclass in CLOS.
...
;; Returns a string which is the java source representation of the java class
;; encapsulated by *java-class*.
;; java-class: A class metaobject encapsulating a java class.
(defmethod write-java-class ( java-class-name (java-class java-metalevel-class))
