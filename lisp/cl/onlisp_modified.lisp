(defpackage "ONLISP"
  (:export "RFIND-IF" "TTRAV" "TREC" "MAC" "WHEN-BIND" "WHEN-BIND*" "WITH-GENSYMS"
	   "IF3" "NIF"))

(proclaim '(inline last1 single append1 conc1 mklist))
(proclaim '(optimize speed))

;; Last element of a proper list.
(defun last1 (lst)
  (car (last lst)))

;; Does the list consist of just a single element?
(defun single (lst)
  (and (consp lst) (not (cdr lst))))

;; Attach obj to the lst.
