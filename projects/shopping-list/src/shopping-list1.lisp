...
(defun gen-shopping-list/expanded ()
  "Generates the *expanded* shopping list by following the foreign
  keys (i.e *shopping_item_id* and *shopping_item_details_id*) in the
  *shopping_list* table to retreive the actual *shopping_item* and
  *shopping_item_details* referenced by those keys. in the 
  shopping_list table. As the *shpping_list* table just contains foreign
  keys referencing *shopping_item* and *shopping_item_details*shopping-requests from the
  database"
