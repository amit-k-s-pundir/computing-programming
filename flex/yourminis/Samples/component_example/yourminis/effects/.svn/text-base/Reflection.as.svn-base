...
{   
    ...
    */
    ...
    public class Reflection extends Sprite {
		...
		private var _numMidFade:Number = .5;
        ...
        // Constructor
        public function Reflection(set_disTarget:DisplayObject, set_numStartFade:Number, set_numMidFade, set_numEndFade:Number, set_numMidLoc:Number, set_numSkewX:Number, set_numScale:Number) {
            super()
            _disTarget = set_disTarget;
            _numStartFade = set_numStartFade;
            _numMidFade = set_numMidFade;
        ...
        public function createReflection():void {
            ...
            var arrAlpha:Array = new Array(_numStartFade, _numMidFade, _numEndFade);
