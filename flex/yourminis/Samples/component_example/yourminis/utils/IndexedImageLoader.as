package yourminis.utils
{
	...
	public class IndexedImageLoader extends Sprite
	{
		...
		public function IndexedImageLoader(_index,_callBack,__url:String="",__maxWidth:Number=0,__maxHeight:Number=0,_preserveRatio:Boolean=false,_showIndicator:Boolean=false,_centerImage:Boolean=false,_padding:Number=0,_frameColor:int=-1,_frameBorderColor:int=-1)
		{
			index = _index;
			callBack = _callBack;
			_url = __url;
		...
		public function mclick(evt:MouseEvent) {
			callBack(index);
		}
